...
public class Advantage extends SerializableObject implements Cloneable, Enums
{
   ...
   {
      this.name = name;
      this.hasEffectInSimulator = hasEffectInSimulator;
      this.costs = costs;
   ...
   public static final List<Advantage> advList = new ArrayList<>();
   static {
      advList.add(new Advantage(ABSOLUTE_DIRECTION, false, new String[] {}, new int[] {5}, new String[] {}, new String[] {}, "Absolute Direction lets the bearer know which direction north is at all times, even when underground. These individuals will almost never become lost."));
      advList.add(new Advantage(ABSOLUTE_TIMING, false, new String[] {}, new int[] {5}, new String[] {}, new String[] {}, "Absolute Timing allows the bearer to know exactly what of day it is at all times. They are also extremely accurate at estimating length of time."));
      advList.add(new Advantage(ADDICTION, false,
      ...
      advList.add(new Advantage(ALERTNESS, false,
      ...
      advList.add(new Advantage(AMBIDEXTROUS, true, new String[] {}, new int[] {10}, new String[] {}, new String[] {HANDS_0, DISFIGURED_ARMS, DISFIGURED_HANDS}, "Ambidextrous individuals can use either hand equally well, and may even fight with two swords at once, using each one as well as the other."));
      advList.add(new Advantage(APPEARANCE, false,
      ...
      advList.add(new Advantage(BAD_TEMPER, false, new String[] {}, new int[] {-5}, new String[] {}, new String[] {}, "Having a Bad Temper causes the bearer to resort to the use of force more often than trying to talk it out. In hostile situations, the bearer of the 'bad temper' disadvantage has a -2 penalty to all SOC rolls."));
      advList.add(new Advantage(BERSERKER, true, new String[] {}, new int[]{-10}, new String[] {}, new String[] {}, "A Berserker character is one who enters a rage any time they experience pain. While in this state, they are not able to think clearly, and are focused solely on attacking whoever it was that inflicted their pain. In this state, a Berserker is not able to move evasively, retreat, parry, block or cast spells. They may also not ready a new weapon, but may re-ready anything already in their hand(s). The only active defense a berserking character may take is to dodge. In exchange for these penalties, a berserking character is unaffected by pain while in his enraged state. Wounds still affect the character as normal. Any time a berserker character is hit, and takes pain, he must roll 2-action IQ against a TN of his pain level to avoid going into the berserking state. Once in this state, he will remain berserking until the character that inflicted the pain is dead or unconscious. Once that happens, the berserker must make a 1-action IQ roll against a TN of his current pain level, plus 3, or he will continue his berserking rage, attacking the next nearest enemy in front of him. If the berserker rolls the minimum possible roll (a 1 on each die rolled), then the berserking character will attack the nearest person in front of him, friend or foe alike!"));
      advList.add(new Advantage(CODE_OF_CONDUCT, false,
      ...
      advList.add(new Advantage(DIVINE_POWER, true,
      ...
      advList.add(new Advantage(DISFIGURED_ARMS, false,
      ...
      advList.add(new Advantage(DISFIGURED_FACE, false,
      ...
      advList.add(new Advantage(DISFIGURED_HANDS, false,
      ...
      advList.add(new Advantage(DISFIGURED_LEGS, false,
      ...
      advList.add(new Advantage(HERO_POINTS, true,
                                new String[] {"0", "1", "2", "3"},
      ...
      advList.add(new Advantage(HONEST, false, new String[] {}, new int[] {-5}, new String[] {}, new String[] {COMPULSIVE_LIAR}, "Honest character find it very difficult to lie, will always avoid doing so. If they do have to lie, the lie will often be obvious. Other individuals that know about the bearers honest will usually treat this person favorably, and believe what they say to be truthful."));
      advList.add(new Advantage(INFRA_VISION, false, new String[] {}, new int[]  {0}, new String[] {INFRA_VISION}, new String[] {NIGHT_VISION}, "Characters with infra vision are able to see the infrared spectrum of light. All objects emit varying levels of infrared radiation, which can be seen by these individuals. This allows them to see in total darkness. The ‘Infra-vision’ advantage may not be purchased, but some races (notably Orcs and Elves) have this advantage intrinsically."));
      advList.add(new Advantage(INTOLERANT, false, new String[] {}, new int[]{-15}, new String[] {}, new String[] {}, "Intolerant characters must pick what they are intolerant of. Some common intolerants includes: intolerance of other (or particular) races, intolerance of those of other religions or intolerance of magic-use. Intolerant characters will always treat those that they are intolerant of poorly, and with disgust and disrespect. Oftentimes, the manner in which they treat the subject of their intolerance lead to physical confrontation."));
      advList.add(new Advantage(LAZY, false, new String[] {}, new int[] {-5}, new String[] {}, new String[] {}, "Lazy character try to avoid work at all costs."));
      advList.add(new Advantage(LITERACY, false, new String[] {}, new int[] {10}, new String[] {}, new String[] {}, "In medieval time, and in many fantasy campaigns, knowing how to read and write is not commonplace. In these worlds, Literacy is an advantage costing 10 points, while being illiterate does not alter your character’s points at all. In modern times, or in campaigns where the GM rules that Literacy is the norm, Illiteracy is a -10 point disadvantage."));
      advList.add(new Advantage(KNIGHTHOOD, false, new String[] {}, new int[] {10}, new String[] {}, new String[] {}, "Individuals may be knighted by a king for their exceptional support of the kingdom. Knighted individuals are awarded a family coat-of-arms, and must always be address as ‘Sir’ or ‘Dame’, and their honor should never be called into question. Being knighted affords the knight a higher status, equivalent to a boost to their social rank advantage described later."));
      advList.add(new Advantage(LECHEROUS, false, new String[] {}, new int[] {-5}, new String[] {}, new String[] {}, "Lecherous characters find it difficult to avoid flirt with attractive members of the opposite sex. They are easily manipulated by members of the opposite sex."));
      advList.add(new Advantage(MAGICAL_APTITUDE, true,
                                new String[] {"+1", "+2", "+3", "+4", "+5"},
      ...
      advList.add(new Advantage(MAGIC_RESISTANCE, true,
                                new String[] {"+1", "+2", "+3", "+4", "+5"},
      ...
      advList.add(new Advantage(MEGALOMANIAC, false, new String[] {}, new int[]{-10}, new String[] {}, new String[] {}, "A megalomaniac is someone who seeks to control everything around them. Given the opportunity, they will seek to dominate the entire world."));
      advList.add(new Advantage(MUTE, false, new String[] {}, new int[]{-15}, new String[] {}, new String[] {COMPULSIVE_LIAR}, "A mute is unable to speak. If they have learned the sign language skill, they may still comunicate with others that can sign. A mute character often suffers from social stigma from those that are not empathetic to their condition. As a result, a mute suffers a -1 in all social settings, except for those involving those that are simpathetic to their condition."));
      advList.add(new Advantage(NIGHT_VISION, false, new String[] {}, new int[] {10}, new String[] {NIGHT_VISION}, new String[] {INFRA_VISION}, "Characters with night vision are able to see reasonably well in low-light conditions. The vision of a character with night vision will be the same from daytime to a night lit by the full moon. They will even be able to see in a star-lit night, at a penalty, but much less significant than those without the night vision advantage."));
      advList.add(new Advantage(NO_PAIN, true, new String[] {}, new int[]{125}, new String[] {NO_PAIN}, new String[] {}, "Characters that feel no pain are never affected by pain caused by wounds. They are still affected by their wound level, however. The ‘no pain’ advantage may not be purchased, but some races (such as all undead races) have this advantage intrinsically."));
      advList.add(new Advantage(PERIPHERAL_VISION, true, new String[] {}, new int[] {10}, new String[] {PERIPHERAL_VISION}, new String[] {}, "Characters with peripheral vision can see 360 degree around them."));
      advList.add(new Advantage(PHOBIA             , false,
      ...
      advList.add(new Advantage(PHOTOGRAPHIC_MEMORY, false, new String[] {}, new int[] {25}, new String[] {}, new String[] {}, "Individuals with photographic memory are able to recall fine details in images and sounds from recent memory after having only a few moments of exposure. They also have extraordinary long-term recollection of events and details. They cannot recall conversations from over a month ago word-for-word, but they can recall many details much longer than normal individuals."));
      advList.add(new Advantage(PSYCHOTIC          , false, new String[] {}, new int[]{-10}, new String[] {}, new String[] {}, "Psychotic indivuals have a difficulty discerning what is real, and what is not real. Psychotic individuals often have delusions, which always seem very real, no matter how bizarre they seem to normal people."));
      advList.add(new Advantage(QUIRKS, false,
      ...
      advList.add(new Advantage(RANK_MILITARY_ENLISTED, false,
      ...
      advList.add(new Advantage(RANK_MILITARY_OFFICER, false,
      ...
      advList.add(new Advantage(RANK_SOCIAL_MALE, false,
                                new String[] {"Slave", "Peasant", "Serf", "Commoner", "Baron", "Viscount","Count", "Duke", "Prince", "King", "Emperor"},
                                new int[] {       -15,       -10,     -5,          0,       5,         10,     15,     25,       50,    100,       300}, new String[] {Race.Gender.MALE.name}, new String[] {Race.Gender.FEMALE.name, RANK_SOCIAL_FEMALE}, "Rank is a pecking order within society. There are multiple types of rank, such as military rank or social rank. In all cases, the higher a person’s rank, the more respect they command, and the more preferential treatment they get. Rank also determines how an individual must be addresses, as well as how lower ranked individuals are required to interact with them. Failure to obey a higher ranked individual or not treating them with the required etiquette and respect may result in severe penalties, such as public floggings, jail time, fines, loss or rank and in some cases even execution. A single individual may have both a single social rank as well as a single military rank. Higher ranks usually go hand-in-hand with an increased wealth level and often a sense of duty (especially the military ranks), each of which are separately purchased advantages and disadvantages."));
      advList.add(new Advantage(RANK_SOCIAL_FEMALE, false,
                                new String[] {"Slave", "Peasant", "Serf", "Commoner", "Baronness", "Viscountess","Countess", "Duchess", "Princess", "Queen", "Empress"},
                                new int[] {       -15,       -10,     -5,          0,           5,            10,        15,        20,         30,      50,       100}, new String[] {Race.Gender.FEMALE.name}, new String[] {Race.Gender.MALE.name, RANK_SOCIAL_MALE}, "Rank is a pecking order within society. There are multiple types of rank, such as military rank or social rank. In all cases, the higher a person’s rank, the more respect they command, and the more preferential treatment they get. Rank also determines how an individual must be addresses, as well as how lower ranked individuals are required to interact with them. Failure to obey a higher ranked individual or not treating them with the required etiquette and respect may result in severe penalties, such as public floggings, jail time, fines, loss or rank and in some cases even execution. A single individual may have both a single social rank as well as a single military rank. Higher ranks usually go hand-in-hand with an increased wealth level and often a sense of duty (especially the military ranks), each of which are separately purchased advantages and disadvantages."));
      advList.add(new Advantage(REGENERATION, true, new String[] {}, new int[] {0}, new String[] {REGENERATION}, new String[] {}, "Regeneration allows an individual to heal their wounds very quickly. Any time a pain roll is rolled, and the pain reduction is 10 points or more, the character heals one wound from any random previous damage. Crippled limbs become un-crippled after all the wounds on that limb are healed.. The ‘regeneration’ advantage may not be purchased, but some races (notably trolls) have this advantage intrinsically."));
      advList.add(new Advantage(SADISTIC, false, new String[] {}, new int[] {-5}, new String[] {}, new String[] {}, "Sadists take pleasure in putting other individuals in pain."));
      advList.add(new Advantage(SENSE_OF_DUTY, false,
      ...
      advList.add(new Advantage(SPLIT_PERSONALITIES, false, new String[] {}, new int[]{-20}, new String[] {}, new String[] {}, "Characters with split personalities are just like two (or more) people. They have different mental advantages or disadvantages, and even different levels of intelligence, dexterity, toughness, and social abilities."));
      advList.add(new Advantage(UNUSUAL_BACKGROUND, false,
      ...
      advList.add(new Advantage(WEALTH, true,
      ...
      advList.add(new Advantage(WEALTH_MULTIPLIER_x2, true, new String[] {}, new int[]{10}, new String[] {WEALTH_MULTIPLIER_x2}, new String[] {}, "Wealth multipliers are assigned to each race. This value multiplies the starting wealth for any character."));
      advList.add(new Advantage(WEALTH_MULTIPLIER_x3, true, new String[] {}, new int[]{20}, new String[] {WEALTH_MULTIPLIER_x3}, new String[] {}, "Wealth multipliers are assigned to each race. This value multiplies the starting wealth for any character."));
      advList.add(new Advantage(WEALTH_MULTIPLIER_2, true, new String[] {}, new int[]{-5}, new String[] {WEALTH_MULTIPLIER_2}, new String[] {}, "Wealth multipliers are assigned to each race. This value multiplies the starting wealth for any character."));
      advList.add(new Advantage(WEALTH_MULTIPLIER_3, true, new String[] {}, new int[]{-10}, new String[] {WEALTH_MULTIPLIER_3}, new String[] {}, "Wealth multipliers are assigned to each race. This value multiplies the starting wealth for any character."));
      advList.add(new Advantage(WEALTH_MULTIPLIER_4, true, new String[] {}, new int[]{-15}, new String[] {WEALTH_MULTIPLIER_4}, new String[] {}, "Wealth multipliers are assigned to each race. This value multiplies the starting wealth for any character."));
      advList.add(new Advantage(WEALTH_MULTIPLIER_5, true, new String[] {}, new int[]{-20}, new String[] {WEALTH_MULTIPLIER_5}, new String[] {}, "Wealth multipliers are assigned to each race. This value multiplies the starting wealth for any character."));
      advList.add(new Advantage(WINGED_FLIGHT, true, new String[] {}, new int[]  {0}, new String[] {WINGED_FLIGHT}, new String[] {}, "Winged flight allows the individual to fly through the air. The ‘winged flight’ advantage may not be purchased, but some races (notably Fairies) have this advantage intrinsically."));
   }
   ...
   boolean isAllowed(List<String> existingProperties, Race race)
   {
      for (String conflict : conflicts) {
         ...
         if ((race != null) && (race.getGender().name.equals(conflict))) {
            return false;
         }
      }
      for (String requirement : requirements) {
         if (!existingProperties.contains(requirement)) {
            ...
            if (!race.getName().equals(requirement)) {
               if (!race.getGender().name.equals(requirement)) {
                  return false;
               }
            }
         }
   ...
   public static Advantage getAdvantage(String name)
   {
      if (name != null) {
         for (Advantage advantage : advList) {
            if (advantage.name.equalsIgnoreCase(name)) {
         ...
         for (Advantage advantage : advList) {
            if (name.startsWith(advantage.name.toLowerCase())) {
               Advantage adv = advantage.clone();
               String selectedLevelName = name.substring(advantage.name.length() + 1).trim();
      ...
      if (race != null) {
         ...
         for (Advantage adv  : racialAdvantages) {
            if (adv.getName().equals(getName())) {
               int costForRacialLevel = costs[adv.level];
               return costs[level] - costForRacialLevel;
            }
         }
      }
      return costs[level];
   ...
   public boolean hasLevels()               { return levels.size() > 0;}
   ...
   public Advantage clone() {
      ...
      return new Advantage(name, false, levels.toArray(type), costs, requirements.toArray(type), conflicts.toArray(type), "");
   }
   @Override
   ...
   public void serializeFromStream(DataInputStream in)
   {
      ...
      Advantage base = getAdvantage(name);
      name = base.name;
      costs = base.costs;
   ...
   public String toString() {
      return name + (((levels != null) && (level >= 0) && (levels.size() > level)) ? (": " + levels.get(level)) : "");
   }
      ...
      for (Advantage adv : advList) {
         ...
         if (adv.hasLevels()) {
            ...
            for (int i=0 ; i<levelNames.size() ; i++) {
               ...
               row.addTD(new TableData(adv.costs[i]).setAttribute("nowrap", "true"));
               table.addRow(row);
            }
            sb.append(table);
            sb.append("</td>");
            ...
            sb.append("<td>").append(adv.costs[0]).append("</td>");
         }
         sb.append("<td class='alignLeft'>").append(adv.getDescripton());
         if (!adv.hasEffectInSimulator) {
   ...
   public boolean equals(Object other) {
      ...
      if (other instanceof Advantage) {
         ...
         return name.equals(otherAdv.name) && (level == otherAdv.level);
      }
      return false;
   }
}
