...
public class Race implements Cloneable, Enums
{
   ...
   public String getPluralName() {
      switch (name) {
         case NAME_Fairy:     return "Fairies";
         case NAME_HalfElf:   return "Half-Elves";
         case NAME_Elf:       return "Elves";
         case NAME_Dwarf:     return "Dwarves";
         case NAME_LizardMan: return "Lizard Men";
         case NAME_InsectMan: return "Insect Men";
         case NAME_Cyclops:   return "Cyclopses";
         case NAME_Fox:       return "Foxes";
         case NAME_Wolf:      return "Wolves";
      }
      int commaLocation = name.indexOf(',');
      if (commaLocation != -1) {
         return name.substring(0, commaLocation) + 's' + name.substring(commaLocation);
      }
      return name + "s";
   }
   ...
   static final Race[] raceList = new Race[] {
       ...
       new Race(NAME_Fairy,           Gender.MALE,       5, -29, -7,  1.0,   6,          BodyType.HUMANIOD,1.0, 1.0, new byte[] { 0,  0, -2,  0,  3,  2,  2}, new String[] {PROPERTIES_2_WINGS}, new String[] {Advantage.WEALTH_MULTIPLIER_x3, Advantage.WINGED_FLIGHT, Advantage.MAGICAL_APTITUDE+":+2"}, new String [] {}),
       new Race(NAME_Fairy,           Gender.FEMALE,     5, -29, -7,  1.0,   6,          BodyType.HUMANIOD,1.0, 1.0, new byte[] {-2,  0, -2,  0,  3,  2,  3}, new String[] {PROPERTIES_2_WINGS}, new String[] {Advantage.WEALTH_MULTIPLIER_x3, Advantage.WINGED_FLIGHT, Advantage.MAGICAL_APTITUDE+":+2"}, new String [] {}),
       ...
       new Race(NAME_Ogre,            Gender.MALE,     230,  10,  2,  850,   6,          BodyType.HUMANIOD,1.0, 1.0, new byte[] { 3,  0,  0, -3, -3, -1, -3}, new String[] {PROPERTIES_NPC, ""}, new String[] {Advantage.WEALTH_MULTIPLIER_3}, new String [] {}),
       new Race(NAME_Ogre,            Gender.FEMALE,   210,  10,  2,  850,   6,          BodyType.HUMANIOD,1.0, 1.0, new byte[] { 1,  0,  0, -3, -3, -1, -2}, new String[] {PROPERTIES_NPC, ""}, new String[] {Advantage.WEALTH_MULTIPLIER_3}, new String [] {}),
       ...
       new Race(NAME_Troll,           Gender.MALE,     400,  10,  2,  850,   7,          BodyType.HUMANIOD,1.0, 1.0, new byte[] { 3,  5,  2, -2, -2,  0, -4}, new String[] {PROPERTIES_NPC, PROPERTIES_REGENERATIVE}, new String[] {Advantage.WEALTH_MULTIPLIER_5, Advantage.REGENERATION, Advantage.BAD_TEMPER}, new String [] {}),
       new Race(NAME_Troll,           Gender.FEMALE,   375,  10,  2,  850,   7,          BodyType.HUMANIOD,1.0, 1.0, new byte[] { 1,  5,  2, -2, -2,  0, -3}, new String[] {PROPERTIES_NPC, PROPERTIES_REGENERATIVE}, new String[] {Advantage.WEALTH_MULTIPLIER_5, Advantage.REGENERATION, Advantage.BAD_TEMPER}, new String [] {}),
       ...
       new Race(NAME_Sturge,          Gender.MALE,    -100, -21, -5,  4.0,   6,              BodyType.BIRD,1.0, 1.0, new byte[] { 0,  0,  0, -8,  2,  2,  0}, new String[] {PROPERTIES_NPC, PROPERTIES_0_ARMS, PROPERTIES_NIGHT_VISION, PROPERTIES_2_WINGS, PROPERTIES_ANIMAL, PROPERTIES_FUR, PROPERTIES_STURGEBREAK}, new String[] {"Wealth:$0", Advantage.NIGHT_VISION, Advantage.WINGED_FLIGHT, Advantage.HANDS_0}, new String [] {}),
       new Race(NAME_Sturge,          Gender.FEMALE,  -100, -21, -5,  4.0,   6,              BodyType.BIRD,1.0, 1.0, new byte[] { 0,  0,  0, -8,  2,  2,  0}, new String[] {PROPERTIES_NPC, PROPERTIES_0_ARMS, PROPERTIES_NIGHT_VISION, PROPERTIES_2_WINGS, PROPERTIES_ANIMAL, PROPERTIES_FUR, PROPERTIES_STURGEBREAK}, new String[] {"Wealth:$0", Advantage.NIGHT_VISION, Advantage.WINGED_FLIGHT, Advantage.HANDS_0}, new String [] {}),
...
//       new Race(NAME_Horse_Draft,     Gender.FEMALE,   400,  14,  3, 1700,   10,     BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 4,  2,  1, -6, -1, -1,  0}, new String[] {PROPERTIES_NPC, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_ANIMAL}, new String[] {"Wealth:$0", Advantage.VISION+":Poor Sight", Advantage.PERIPHERAL_VISION}, new String [] {}),
       ...
       new Race(NAME_Dragon,          Gender.MALE,     850,  18,  3, 3500,   7,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 0,  1,  2,  1,  1,  1,  2}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+2", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Dragon,          Gender.FEMALE,   850,  18,  3, 3500,   7,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 0,  1,  2,  1,  1,  1,  2}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+2", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Large_Dragon,    Gender.MALE,    1200,  24,  5, 9500,   8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 0,  1,  3,  2,  0,  2,  3}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+3", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Large_Dragon,    Gender.FEMALE,  1200,  24,  5, 9500,   8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 0,  1,  3,  2,  0,  2,  3}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+3", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Huge_Dragon,     Gender.MALE,    1500,  30,  6,27500,   8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 0,  0,  3,  3,  0,  2,  4}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+4", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Huge_Dragon,     Gender.FEMALE,  1500,  30,  6,27500,   8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] { 0,  0,  3,  3,  0,  2,  4}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+4", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Ancient_Dragon,  Gender.MALE,    1900,  36,  8,75000,   8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] {-1, -1,  2,  4, -1,  2,  4}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+5", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Ancient_Dragon,  Gender.FEMALE,  1900,  36,  8,75000,   8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] {-1, -1,  2,  4, -1,  2,  4}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+5", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Legendary_Dragon,Gender.MALE,    2300,  42,  9,220000,  8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] {-1, -2,  2,  5, -1,  1,  5}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+5", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
       new Race(NAME_Legendary_Dragon,Gender.FEMALE,  2300,  42,  9,220000,  8,      BodyType.SERPENTINE_3,1.0, 1.0, new byte[] {-1, -2,  2,  5, -1,  1,  5}, new String[] {PROPERTIES_NPC, PROPERTIES_NIGHT_VISION, PROPERTIES_THICK_SCALES, PROPERTIES_ANIMAL, PROPERTIES_4_LEGS, PROPERTIES_0_ARMS, PROPERTIES_FANGS, PROPERTIES_CLAWS, PROPERTIES_TAIL, PROPERTIES_2_WINGS}, new String[] {"Wealth:$0", Advantage.MAGICAL_APTITUDE+":+5", Advantage.NIGHT_VISION, Advantage.PERIPHERAL_VISION}, new String [] {SpellFlameJet.NAME + ":1"}),
