...
public class SpellRaiseDead extends MageSpell
{
   ...
   public SpellRaiseDead() {
      super(NAME, new Class[] {SpellControlMind.class, SpellResistPain.class},
                  new MageCollege[] {MageCollege.NECROMANCY});
   }
   ...
   public String describeSpell() {
      ...
      return "The Raise Dead spell reanimates one corpse for one hour."
             ...
             + " spell specifically for attributes and skills. Similarly, the skills of the zombie"
             + " will be equal to their living level but will not exceed the power points of the"
             + " spell for attributes and skills times two."
             + " Zombies normally stay around for 1 hour; however, power points may be allocated"
             + " away from skills and attributes to prolong the zombie’s existence."
             + " For example, given the corpse of a fallen warrior who had a STR of 4 and a DEX of 2,"
             + " and a sword and skill level of 5: A necromancer casting this spell with 3 power points"
             + " (all allocated to attributes and skills) would raise this zombie with its STR at 3,"
             + " and DEX at 2, and skill levels of 5 for 1 hour."
             + " The same caster could instead spend two of his power points on duration,"
             + " raising the zombie with a STR and DEX of 1 and skill levels of 2 for 1 day."
             + table
             ...
             + " the Ogre’s maximum attribute level would be a 1, and its maximum skill level 2,"
