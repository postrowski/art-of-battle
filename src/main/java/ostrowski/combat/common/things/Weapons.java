...
public class Weapons {
   ...
   static {
      ...
      weaponsList = new SizelessWeapon[] {
              ...
              new WeaponBase(3,5.5,7000,Weapon.NAME_BastardSword_Fine,new WeaponStyle[]{new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Swing (1h)", 2, -4, 7, 11, DieType.D6, DamageType.CUT, AttackType.SWING, WeaponStyleAttack.Charge.Never, 0, 2, 3, 1),
              ...
              new WeaponBase(3,3.5,5500,Weapon.NAME_Longsword_Fine, new WeaponStyle[] {new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Swing", 2, -6, 1, 11, DieType.D6, DamageType.CUT, AttackType.SWING, WeaponStyleAttack.Charge.Never, 0, 2, 2, 1),
                                                                                                      new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Thrust", 1, -3, 7, 7, DieType.D8, DamageType.IMP, AttackType.THRUST, WeaponStyleAttack.Charge.Never, 0, 2, 2, 1),
              ...
              new WeaponBase(3,4.5,6500,Weapon.NAME_Broadsword_Fine,new WeaponStyle[] {new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Swing", 2, -3, 4, 12, DieType.D6, DamageType.CUT, AttackType.SWING, WeaponStyleAttack.Charge.Never, 0, 2, 2, 1),
                                                                                                      new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Thrust", 1, -3, 8, 7, DieType.D8, DamageType.IMP, AttackType.THRUST, WeaponStyleAttack.Charge.Never, 0, 2, 2, 1),
                                                                                                      new WeaponStyleParry(      SkillType.Sword,            0, 0,       "Parry",  1,  -2,  99,  1.0, 1)}),
              ...
              new WeaponBase(2,2.5,4000,Weapon.NAME_Shortsword_Fine,new WeaponStyle[] {new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Swing", 1, -3, 6, 8, DieType.D6, DamageType.CUT, AttackType.SWING, WeaponStyleAttack.Charge.Never, 0, 2, 2, 1),
                                                                                                      new WeaponStyleAttackMelee(SkillType.Sword, 0, 0, "Thrust", 1, -99, 3, 8, DieType.D8, DamageType.IMP, AttackType.THRUST, WeaponStyleAttack.Charge.Never, 0, 2, 2, 1),
                                                                                                      new WeaponStyleParry(      SkillType.Sword,            0, 0,       "Parry",  1, -99,   3,  1.0, 1)}),
              //           size,lbs,  $, name                                             2               (SkillType,                 min,pen.,   StyleName,spd,Str-,Str+, dam,  Die,             damageType,     attackType,       charge type, pry-,ranges hands)
              ...
              new WeaponBase(2, 4,  75, Weapon.NAME_ThreePartStaff, new WeaponStyle[] {new WeaponStyleAttackMelee(SkillType.NunChucks, 2, 2, "Long Swing", 1, -5, 99, 8, DieType.D8, DamageType.BLUNT, AttackType.SWING, WeaponStyleAttack.Charge.Never, 0, 3, 4, 2),
              ...
              new WeaponBase(3,8,8500,Weapon.NAME_TwoHandedSword_Fine,new WeaponStyle[]{new WeaponStyleAttackMelee(SkillType.TwoHanded_Sword, 0, 0, "Swing", 2, -4, 6, 14, DieType.D6, DamageType.CUT, AttackType.SWING, WeaponStyleAttack.Charge.Never, 0, 2, 3, 2),
                                                                                                       new WeaponStyleAttackMelee(SkillType.TwoHanded_Sword, 0, 0, "Thrust", 2, -99, 2, 8, DieType.D10, DamageType.IMP, AttackType.THRUST, WeaponStyleAttack.Charge.Never, 0, 2, 3, 2),
                                                                                                       new WeaponStyleParry(      SkillType.TwoHanded_Sword,  0, 0,       "Parry",  1,  -3,  99,  1.0, 2)}),
