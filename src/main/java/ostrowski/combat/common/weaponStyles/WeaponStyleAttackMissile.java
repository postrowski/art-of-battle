...
public class WeaponStyleAttackMissile extends WeaponStyleAttackRanged
{
   ...
   public WeaponStyleAttackMissile(SkillType skillType, SkillRank minRank, int skillPenalty,
                                   int damageMod, DiceSet varianceDice, DamageType damageType,
                                   int rangeBase, int handsRequired, String[] preparationSteps)
   {
      super(skillType, minRank, skillPenalty, "Shoot", damageMod,
   ...
   {
      WeaponStyleAttackMissile style = new WeaponStyleAttackMissile(skillType, minRank, skillPenalty,
