...
{
   public WeaponStyleCounterAttack(SkillType skillType, SkillRank minRank, int skillPenalty, String name,
   ...
   {
      WeaponStyleCounterAttack style = new WeaponStyleCounterAttack(skillType, minRank, skillPenalty, name,
